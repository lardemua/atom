...
if __name__ == '__main__':
    ...
    rviz_file = atom_calibration_path + '/templates/config.rviz'
    ...
    yaml.dump(rviz, open(atom_calibration_path + '/templates/config_new.rviz', 'w'))

    # lines = []
    # fd = open(atom_calibration_path + '/templates/config.rviz', 'r+')
...
#         config = rviz.Config()
#         reader.readFile(config, atom_calibration_path + '/templates/config.rviz')
