...
class Additional_tf:
    ...
    def __init__(self, name, server, global_menu_handler, frame_world, frame_opt_parent, frame_opt_child, frame_additional_tf, additional_tf_color, marker_scale):
        ...
        self.service_set_visible = rospy.Service('~' + self.name + '/set_additional_tfs_interactive_marker',
        ...
        self.service_get_visible = rospy.Service('~' + self.name + '/get_additional_tfs_interactive_marker',
    ...
    def callbackSetAdditionalTfsInteractiveMarker(self, request):
        ...
        print('callbackSetAdditionalTfsInteractiveMarker service requested for additional_tfs ' + colorama.Fore.BLUE +
    ...
    def resetToInitalPose(self, feedback=None):
        print('resetToInitialPose called for additional_tfs ' + colorama.Fore.BLUE + self.name + colorama.Style.RESET_ALL)
    ...
    def markerFeedback(self, feedback):
        # print(' additional_tfs ' + self.name + ' received feedback')
    ...
    def updatePosT(self):
        self.posT = self.updateT(self.opt_child_link, self.additional_tfs_link, rospy.Time.now())
