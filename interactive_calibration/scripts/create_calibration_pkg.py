...
import rospy
from interactive_calibration.utilities import resolvePath, execute
...
if __name__ == "__main__":
    ...
    assert (not os.path.exists(package_path)), Fore.RED + 'Folder ' + package_path + \
    ...
    # Create package
    print('Creating package ' + package_name + ' on path ' + package_base_path + ' please wait ...')
    cmd = 'cd ' + package_base_path + ' && catkin_create_pkg ' + package_name + ' rospy ' + \
    ...
    config_file_dst = package_path + '/calibration/config.yml'
    ...
    # Print final report
    print('\n\nCreated calibration package ' + package_name + ' in ' + package_base_path + '. Now you should:')
